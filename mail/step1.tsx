...
const Step1VerificationEmail = ({
  name,
  verificationUrl,
}: Step1VerificationEmailProps) => {
  return (
    <Html lang="de">
      <Tailwind>
        <Head>
          <title>Verifikation des Studierendenstatus fortsetzen</title>
        </Head>
          ...
          <Container className="bg-white rounded-[8px] p-[32px] mx-auto my-0 max-w-[600px]">
            ...
            <Section>
              ...
              <Text className="text-[16px] leading-[24px] text-gray-700 mb-[24px]">
                Bitte fahre hier fort, um deine Hochschulzugehörigkeit zu
                verifizieren:
              </Text>

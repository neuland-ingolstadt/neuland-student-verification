...
interface Step2VerificationEmailProps {
  name: string
  verificationUrl: string
}

const Step2VerificationEmail = ({
  name,
  verificationUrl,
}: Step2VerificationEmailProps) => {
  return (
    <Html lang="de">
      <Tailwind>
        <Head>
          <title>Verifikation des Studierendenstatus abschließen</title>
        </Head>
        <Preview>Deine THI-E-Mail wurde erfolgreich verifiziert</Preview>
          ...
          <Container className="bg-white rounded-[8px] p-[32px] mx-auto my-0 max-w-[600px]">
            ...
            <Section>
              ...
              <Text className="text-[16px] leading-[24px] text-gray-700 mb-[24px]">
                Bitte fahre hier fort, um die Verifikation abzuschließen:
              </Text>
...
Step2VerificationEmail.PreviewProps = {
  name: 'Max Mustermann',
  verificationUrl: 'https://example.com/step3?token=example-token',
}

export default Step2VerificationEmail
